...
var StatementGenerator = /** @class */ (function () {
    ...
    StatementGenerator.generateStatement = function (transactions) {
    ...
    StatementGenerator.generateStatementBetweenDates = function (transactions, dateFrom, dateTo) {
        var selectedTransactions = transactions.filter(function (t) { return (t.getDate() >= dateFrom && t.getDate() <= dateTo); });
